...
const el = {
	...
	about: {
		...
		profileAlt: "Προσωπογραφία του Παναγιώτη Βασδάρη",
		profileCaption: "Ο ΔΗΜΙΟΥΡΓΟΣ",
	...
	video: {
		...
		loopsEyebrow: "ΚΙΝΗΣΗ / ΤΟ ΠΑΤΩΜΑ ΤΟΥ ΜΟΝΤΑΖ",
		loopsTitle: "Κάθε κόψιμο,",
		loopsTitleEm: " ακόμα σε κίνηση",
		loopsTitleAfter: "",
		loopsIntro:
			"Σύντομοι βρόχοι κίνησης και σπουδές από τον ίδιο κόσμο — παίζουν αθόρυβα εδώ, σαν gif. Άνοιξε οποιοδήποτε για να το δεις με ήχο.",
		loopsHint: "ΑΝΟΙΓΜΑ ΜΕ ΗΧΟ ↗",
		loopsOpen: "Άνοιγμα του {label} με ήχο",
		loopsClose: "Κλείσιμο αναπαραγωγής",
		loopsDialogLabel: "Αναπαραγωγή βίντεο",
		loopsMeta: "07 ΒΡΟΧΟΙ + 01 ΣΟΟΥΡΙΛ",
		posterTitle: "Το Δέος",
		posterTitleEm: " της Ανθρωπότητας",
		posterTitleAfter: "",
		posterMeta: "ΤΟ ΔΕΟΣ ΤΗΣ ΑΝΘΡΩΠΟΤΗΤΑΣ — ΕΠΙΣΗΜΗ ΑΦΙΣΑ",
		posterFormat: "ΤΑΙΝΙΑ ΜΙΚΡΟΥ ΜΗΚΟΥΣ — 2D/3D ANIMATION",
		posterCaption: "ΑΦΙΣΑ",
		posterCaptionEm: "",
		posterAlt: "Η επίσημη αφίσα — Το Δέος της Ανθρωπότητας",
	},
	archive: {
		eyebrow: "ΕΡΓΑ",
		title: "Η",
...
const en: UI = {
	...
	about: {
		...
		identity: "Panayotis Vasdaris",
		role: "Artist / Animator",
		profileAlt: "Portrait of Panayotis Vasdaris",
		profileCaption: "THE CREATOR",
	...
	video: {
		...
		loopsEyebrow: "MOTION / THE CUTTING-ROOM FLOOR",
		loopsTitle: "Every cut,",
		loopsTitleEm: " still in motion",
		loopsTitleAfter: "",
		loopsIntro:
			"Short loops and studies from the same world — running silent here, like gifs. Open any of them to watch it with sound.",
		loopsHint: "OPEN WITH SOUND ↗",
		loopsOpen: "Open {label} with sound",
		loopsClose: "Close player",
		loopsDialogLabel: "Video player",
		loopsMeta: "07 LOOPS + 01 SHOWREEL",
		posterTitle: "The Awe",
		posterTitleEm: " of Humanity",
		posterTitleAfter: "",
		posterMeta: "THE AWE OF HUMANITY — OFFICIAL ONE-SHEET",
		posterFormat: "ANIMATED SHORT FILM — 2D/3D ANIMATION",
		posterCaption: "ONE-SHEET",
		posterCaptionEm: "",
		posterAlt: "Official poster — The Awe of Humanity",
	},
	archive: {
		eyebrow: "WORK",
		title: "The",
